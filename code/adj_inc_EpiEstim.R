estimate_R_adj_inc <- function(incidence_data, P, si_shape, si_rate, si_t_max, start_day, window_length){
  ...
  assignInNamespace("process_I",process_I,ns="EpiEstim") ## overwrite the process_I function in EpiEstim pacakage to supress the error while there are negative values for the incidences, need to restart R to restore this action.
